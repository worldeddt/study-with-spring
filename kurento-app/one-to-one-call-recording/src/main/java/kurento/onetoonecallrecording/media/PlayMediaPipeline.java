...
package kurento.onetoonecallrecording.media;

import static kurento.onetoonecallrecording.messinger.CallMediaPipeline.RECORDING_EXT;
import static kurento.onetoonecallrecording.messinger.CallMediaPipeline.RECORDING_PATH;
...
public class PlayMediaPipeline {
  ...
  public void sendPlayEnd(WebSocketSession session) {
    try {
      ...
      response.addProperty("id", "playEndd");
