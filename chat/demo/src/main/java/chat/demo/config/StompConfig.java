...
import chat.demo.interceptor.InboundChannelInterceptor;
import chat.demo.interceptor.MyHandsShakeHandler;
import chat.demo.interceptor.OutboundChannelInterceptor;
...
public class StompConfig extends StompSessionHandlerAdapter implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("/chat")
                ...
                .setHandshakeHandler(myHandsShakeHandler);
    }
